            ...
            <div class="col-md-10">
                ...
                <div class="body-cart">
                    ...
                    <div class="parrafo-espacio body-parrafo1">
                        <textarea disabled rows="4" name="txt-parrafo1" id="txt-parrafo1"></textarea>
                    ...
                    <div class="parrafo-espacio body-parrafo2">
                        <textarea disabled rows="4"  name="txt-parrafo2" id="txt-parrafo2"></textarea>
                    ...
                    <div rows="4" class="parrafo-espacio body-parrafo3">
                        <textarea disabled rows="4"  name="txt-parrafo3" id="txt-parrafo3"></textarea>
...
@section('scripts')
        <script>
            function enable_text(id_text){
                var txt = $('#'+id_text);
                var dis = !txt.is(':disabled');
                txt.attr('disabled',dis);
            }
            ...
            function get_modelo(id,cod_reclamo){
                $.ajax({
                        ...
                        success: function(response){
                            ...
                            $("#resultado").val(modelo.resultado);
                            $("#resultado_").val(id);
            ...
            function generar_carta(){
                $('#txt-parrafo1').attr('disabled',false);
                $("#txt-parrafo2").attr('disabled',false);
                $("#txt-parrafo3").attr('disabled',false);
